...
import TextCounter        from '../hud/text-counter';
...
export default class BreakoutState extends Phaser.State {
    ...
    create() {
        ...
        new BreakoutBackground(this.game);
         ...
         // Score
        this.score = new TextCounter(this.game, 32, 550, 'score: ', 0, {
            font: "20px Arial",
            fill: "#ffffff",
            align: "left"
        });
        ...
        // Lives
        this.lives = new TextCounter(this.game, 680, 550, 'lives: ', 3, {
            font: "20px Arial",
            fill: "#ffffff",
            align: "left"
        });
